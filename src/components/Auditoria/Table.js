  ...
  render() {
    ...
    elementsTable.push(
      ...
      <StyledTableRow key={i}>
        ...
        <StyledTableCell  style={{ width: '15%' }} align="left">Chefe</StyledTableCell>
        <StyledTableCell  style={{ width: '15%' }} align="left">Representante</StyledTableCell>
        <StyledTableCell style={{ width: '15%' }} align="left">Administrativo</StyledTableCell>
        ...
        <StyledTableCell style={{ width: '10%'}} align="center">{createActions(classes,row.id)}</StyledTableCell>
      </StyledTableRow>
        ...
        <Table className={classes.table}>
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell style={{ width: '15%' }} align="left">Auditor</StyledTableCell>
              <StyledTableCell style={{ width: '15%' }} align="left">Representante</StyledTableCell>
...
function createActions(classes,id) {
  ...
  return (
    <div>
      <Link to={{pathname: '/formResp',state: { id: id }}}>
        <IconButton className={classes.btn} size="small" title="Responder">
          <VisibilityIcon style={{ color: "#6e7573" }} />
        </IconButton>
      </Link>
      <IconButton className={classes.btn} size="small" title="Cancelar">
        <CancelIcon style={{ color: "#6e7573" }} />
      </IconButton>
